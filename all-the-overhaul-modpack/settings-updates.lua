...
--bztin
if mods["bztin"] then
  --change_setting("bztin-more-intermediates", "cable")
...
if mods["RampantFixed"] then
  change_setting("rampantFixed--agressiveStart", true)
  change_setting("rampantFixed--disableCollidingProjectiles", true)
  change_setting("rampantFixed--useDumbProjectiles", true)
  change_setting("rampantFixed--useBlockableSteamAttacks", true)
  change_setting("rampantFixed--attackWaveMaxSize", 75)
  change_setting("rampantFixed--attackWaveMaxSizeEvoPercent", 100)
  ...
  change_setting("rampantFixed--enableSwarme", true)
  change_setting("rampantFixed--enableShrinkNestsAndWorms", true)
  ...
  change_setting("rampantFixed--allowOtherEnemies", false)
  change_setting("rampantFixed--newEnemiesSide", "MIXED")
  change_setting("rampantFixed--newEnemyVariations", 1)
  --how strong biters can get, mostly affects health
  --change_setting("rampantFixed--tierStart", 1)
  --how strong biters can get, mostly affects health
  change_setting("rampantFixed--tierEnd", 10)
  --change_setting("rampantFixed--aiPointsScaler", 1.0)
  change_setting("rampantFixed--aiDifficulty", "Hard")
  change_setting("rampantFixed--allowLongRangeImmunity", true)
  change_setting("rampantFixed--longRangeImmunity_efficiency", 95)
  change_setting("rampantFixed--allowOneshotProtection", true)
  change_setting("rampantFixed--oneshotProtection_efficiency", 90)
  change_setting("rampantFixed--acidEnemy", true)
  change_setting("rampantFixed--laserEnemy", true)
  change_setting("rampantFixed--electricEnemy", true)
  change_setting("rampantFixed--suicideEnemy", true)
  change_setting("rampantFixed--fastEnemy", true)
  change_setting("rampantFixed--waspEnemy", true)
  change_setting("rampantFixed--spawnerEnemy", true)
  change_setting("rampantFixed--trollEnemy", true)
  change_setting("rampantFixed--energyThiefEnemy", true)
  change_setting("rampantFixed--fireEnemy", true)
  change_setting("rampantFixed--ArachnidsEnemy", true)
  change_setting("rampantFixed--physicalEnemy", true)
  change_setting("rampantFixed--infernoEnemy", true)
  change_setting("rampantFixed--poisonEnemy", true)
  change_setting("rampantFixed--nuclearEnemy", true)
  change_setting("rampantFixed--JuggernautEnemy", true)
  change_setting("rampantFixed--unitSpawnerBreath", true)
  change_setting("rampantFixed--enableMigration", true)
  change_setting("rampantFixed--peacefulAIToggle", false)
  change_setting("rampantFixed--peacePeriod", 20)
  change_setting("rampantFixed--raidAIToggle", true)
  change_setting("rampantFixed--siegeAIToggle", true)
  change_setting("rampantFixed--undergroundAttack", false)
  change_setting("rampantFixed--undergroundAttackProbability", 0.15)
  change_setting("rampantFixed--permanentNocturnal", false)
  change_setting("rampantFixed--allowDaytimePlayerHunting", true)
  change_setting("rampantFixed--allowDaytimeNonRampantActions", true)
  change_setting("rampantFixed--aiDifficulty", "Hard")
  change_setting("rampantFixed--showDisableNewEnemiesButton", false)
  change_setting("rampantFixed--settlementsProbability", 0.400)
  change_setting("rampantFixed--vengenceProbabilityPercent", 0.04)
  change_setting("rampantFixed--chainVengenceCoefficient", 0.6)
  change_setting("rampantFixed--removeBloodParticles", true)
  change_setting("rampantFixed--fireSafety-flamethrower", true)
  change_setting("rampantFixed--rampantArsenalRebalance", true)
  change_setting("rampantFixed--unkillableLogisticRobots", false)
  change_setting("rampantFixed--unkillableConstructionRobots", false)
  change_setting("rampantFixed--unitBiterHealthScaler", 1.0)
  change_setting("rampantFixed--unitBiterHealingScaler", 1.0)
  change_setting("rampantFixed--unitBiterSpeedScaler", 1.0)
  change_setting("rampantFixed--unitBiterDamageScaler", 1.0)
  change_setting("rampantFixed--unitBiterRangeScaler", 1.0)
  change_setting("rampantFixed--unitSpitterHealthScaler", 1.0)
  change_setting("rampantFixed--unitSpitterHealingScaler", 1.0)
  change_setting("rampantFixed--unitSpitterSpeedScaler", 1.0)
  change_setting("rampantFixed--unitSpitterDamageScaler", 1.0)
  change_setting("rampantFixed--unitSpitterRangeScaler", 1.0)
  change_setting("rampantFixed--unitDroneHealthScaler", 1.0)
  change_setting("rampantFixed--unitDroneHealingScaler", 1.0)
  change_setting("rampantFixed--unitDroneSpeedScaler", 1.0)
  change_setting("rampantFixed--unitDroneDamageScaler", 1.0)
  change_setting("rampantFixed--unitDroneRangeScaler", 1.0)
  change_setting("rampantFixed--unitWormHealthScaler", 1.0)
  change_setting("rampantFixed--unitWormHealingScaler", 1.0)
  change_setting("rampantFixed--unitWormDamageScaler", 1.0)
  change_setting("rampantFixed--unitWormRangeScaler", 1.0)
  change_setting("rampantFixed--unitSpawnerHealthScaler", 1.0)
  change_setting("rampantFixed--unitSpawnerHealingScaler", 1.0)
  change_setting("rampantFixed--unitSpawnerOwnedScaler", 1.0)
  change_setting("rampantFixed--unitSpawnerSpawnScaler", 1.0)
  change_setting("rampantFixed--unitSpawnerRespawnScaler", 1.0)
  change_setting("rampantFixed--unitHiveRespawnScaler", 1.0)
  change_setting("rampantFixed--unitHiveHealthScaler", 1.0)
  change_setting("rampantFixed--unitHiveHealingScaler", 1.0)
  change_setting("rampantFixed--attackWaveGenerationUsePlayerProximity", true)
  change_setting("rampantFixed--attackPlayerThreshold", 20)
  change_setting("rampantFixed--newEnemies", true)
end
--rampent-evolution
